...
public class Admin_movieAdapter_K extends FirebaseRecyclerAdapter<MovieModel_K,Admin_movieAdapter_K.myviewholder> {
    public Admin_movieAdapter_K(@NonNull FirebaseRecyclerOptions<MovieModel_K> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, @SuppressLint("RecyclerView") int position, @NonNull MovieModel_K model) {
