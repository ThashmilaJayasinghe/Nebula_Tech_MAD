...
public class reviewAdapter_K extends FirebaseRecyclerAdapter<ReviewModel_K,reviewAdapter_K.myviewholder> {
     ...
     * @param options
     */
    public reviewAdapter_K(@NonNull FirebaseRecyclerOptions<ReviewModel_K> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull reviewAdapter_K.myviewholder holder,
    ...
    @NonNull
    @Override
    public reviewAdapter_K.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.review_itemk, parent, false);
        return new reviewAdapter_K.myviewholder(view);
    }
