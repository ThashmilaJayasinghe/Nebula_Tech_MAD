...
public class Admin_tvshowAdapter_K extends FirebaseRecyclerAdapter<TvshowModel_K,Admin_tvshowAdapter_K.myviewholder> {
    public Admin_tvshowAdapter_K(@NonNull FirebaseRecyclerOptions<TvshowModel_K> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, @SuppressLint("RecyclerView") int position, @NonNull TvshowModel_K model) {
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child("TVShow")
