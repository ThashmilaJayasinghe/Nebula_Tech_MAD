...
public class movieAdapter_K extends FirebaseRecyclerAdapter<MovieModel_K,movieAdapter_K.myviewholder> {
    public movieAdapter_K(@NonNull FirebaseRecyclerOptions<MovieModel_K> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull MovieModel_K model) {
